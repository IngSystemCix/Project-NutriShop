...
<head>
  ...
  <title><?php echo APP_NAME . " | " . $palabras["ERROR404"]["titulo_error_404"]; ?></title>
</head>
...
<body class="h-lvh w-full flex flex-col sm:flex-row justify-center items-center gap-[2rem] bg-white-bone dark:bg-dark-gray text-dark-gray dark:text-white-bone">
  <img src="./app/view/img/error404.png" alt="Imagen del Error 404">
  <div class="w-full h-32 px-5 sm:px-0 sm:w-80 sm:h-full text-justify flex flex-col justify-center items-start select-none">
    <h1 class="anton-regular text-8xl uppercase">Error 404</h1>
    <small class="cairo-regular text-lg"><?php echo $palabras["ERROR404"]["mensaje_advertencia_error_404"] ?> <a href="<?php echo APP_URL.'index.php'; ?>" class="underline text-indigo dark:text-green-dark font-bold text-sm"><?php echo $palabras["ERROR404"]["link_error_404"] ?></a></small>
  </div>
